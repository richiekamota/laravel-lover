                ...
                <div class="row table">
                    ...
                    <template v-for="(filteredUnit, index) in filteredUnits">
                        <div class="small-12 columns" v-show="index >= pagination.from && index <= pagination.to">
                            <div class="table__row" :class="{ even: isEven(index), first: index == 0, last: index == filteredUnits.length -1 }">
                                <!-- Row Title -->
                                <button class="accordion__heading" v-on:click="accordionToggle(index, $event)">{{ filteredUnit.code }}
                                </button>
                                <!-- START Edit form -->
                                <div class="accordion__content  --bg-calm">
                                    ...
                                    <template v-for="(occupationDate, index) in filteredUnit.occupation_dates">
                                        ...
                                        <div class="row column">
                                            ...
                                            <p>
                                                <strong>Contract</strong>: {{ occupationDate.contract_id }}</p>

                                            <div class="col row">
                                                <div class="small-6 columns">
                                                    <p>
                                                        <strong>Start Date</strong>: {{ occupationDate.start_date }}</p>
                                                </div>
                                                <div class="small-6 columns">
                                                    <p>
                                                        <strong>End Date</strong>: {{ occupationDate.end_date }}</p>
                                                    <div class="row">
                                                        <div class="small-12 large-8 columns">
                                                            <Flatpickr :options='{ altInput: true, altFormat: "d F Y" }' name="updatedEndDate" placeholder="Edit End Date" v-model="updatedEndDate"
                                                            />
                                                            </Flatpickr>
                                                        </div>
                                                        <div class="small-4 columns">
                                                            <button v-on:click="updateEndDate(occupationDate)" class="button button--small">Submit</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="medium-3 columns">
                ...
                <div class="row column">
                    <label for="filterLocation">
                        <select class="--mb0" ref="filterLocation" id="filterLocation" name="filterLocation" v-model="filterLocation" placeholder="Filter by location">
                ...
                <div class="row column">
                    ...
                    <Flatpickr :options='{ altInput: true, altFormat: "d F Y" }' name="filterStartDate" placeholder="Start Date" v-model="filterStartDate"
                    />
                </div>
                <div class="row column">

                    <Flatpickr :options='{ altInput: true, altFormat: "d F Y" }' name="filterEndDate" placeholder="End Date" v-model="filterEndDate"
                    />
                </div>
                <div class="row column">
                ...
                <div class="row column --border-wrap">
                    <div class="stats-box">
                        ...
                        Units:
                        <span class="float-right">{{filteredUnits.length}}</span>
                        <br/>
                        <br/>
