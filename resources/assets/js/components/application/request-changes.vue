    ...
    <div class="page-items">
        ...
        <div class="row" v-if="application">
            <div class="small-12 medium-8 columns">
                ...
                <!-- Pending comment and other unit selection in here -->
                <div class="row --mt1">
                    <div class="column">
            ...
            <div class="medium-4 columns">
                ...
                <div class="--border-wrap">
                    <div class="stats-box">
                        ...
                        <div class="row column">
                            <p>Finalise this request and email the applicant</p>
                        </div>

                        <div class="row column">
                            <a>
                                <button id="request-changes-application" class="button button--request-changes --expanded" v-on:click="confirmChangesRequested()">
                                    <span v-if="loading">
                                        <loading></loading>
                                    </span>

                                    <template v-if="!loading">
                                        Finalise requesting changes
                                    </template>
                                </button>
                            </a>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            confirmChangesRequested: function () {
                ...
                this.$http.post(
                    ...
                    swal({
                        title: "Success!",
                        text: "The application has been marked draft and the applicant has been emailed.",
                        type: "success",
