    ...
    <div>
        ...
        <div class="row column">
            <div class="page-application__header">
                ...
                <p class="page-application__header-sub">Thanks for choosing MyDomain as your student accommodation
        ...
        <form role="form" method="POST" v-bind:action="formAction" v-on:submit.prevent ref="appForm">
            ...
            <div class="accordion">
                ...
                <!-- START Step 1 -->
                <button class="application-step__heading" v-on:click="accordionToggle(1, $event)" ref="accordion1"
                ...
                <!-- START Step 2 -->
                <button class="application-step__heading" v-on:click="accordionToggle(2, $event)" ref="accordion2"
                        v-bind:class="{ '--disabled' : showStep <  2}" data-accordion="2">Step 2: Leaseholder home
                    ownership
                </button>
                <div class="application-step__content">
                    <template v-if="showStep >= 2">
                        ...
                        <label for="current_property_owner">
                            ...
                            <input type="checkbox" name="current_property_owner"
                                   v-model="appForm.current_property_owner">
                        </label>
                        ...
                        <template v-if="appForm.current_property_owner == false">
                            ...
                            <label for="rental_phone_mobile">
                                Mobile phone number
                                <input type="text" name="rental_phone_mobile" v-model="appForm.rental_phone_mobile"
                                       required>
                            </label>
                        </template>
                ...
                <!-- START Step 3 -->
                <button class=" application-step__heading" v-on:click="accordionToggle(3, $event)" ref="accordion3"
                        v-bind:class="{ '--disabled' : showStep <  3}" data-accordion="3">Step 3: Employment details
                </button>
                <div class="application-step__content">
                    ...
                    <template v-if="showStep >= 3">
                        ...
                        <template v-if="appForm.selfemployed == false">
                            ...
                            <label for="employer_phone_work">
                                ...
                                <input type="text" name="employer_phone_work" v-model="appForm.employer_phone_work"
                                       required>
                            </label>
                        ...
                        <button type="submit" id="step3-save" class="button button--focused" v-on:click="submitStep(3)"
                ...
                <!-- START Step 4 -->
                <button class="application-step__heading" v-on:click="accordionToggle(4, $event)" ref="accordion4"
                    ...
                    <template v-if="showStep >= 4">
                        ...
                        <label for="resident_dob">
                            ...
                            <Flatpickr :options='{ altInput: true, altFormat: "d F Y" }' name="resident_dob"
                                       v-model="appForm.resident_dob" @update='appForm.resident_dob = $event' required/>
                        </label>
                        ...
                        <label for="resident_phone_mobile">
                            Telephone (Mobile)
                            <input type="text" name="resident_phone_mobile" v-model="appForm.resident_phone_mobile"
                                   required>
                        </label>
                        ...
                        <label for="resident_study_location">
                            ...
                            <input type="text" name="resident_study_location" v-model="appForm.resident_study_location"
                                   required>
                        </label>
                        ...
                        <button type="submit" id="step4-save" class="button button--focused" v-on:click="submitStep(4)"
                                v-bind:disabled="loading">
                    <span v-if="loading">
                        <loading></loading>
                    </span>
                ...
                <!-- START Step 5 -->
                <button class=" application-step__heading" v-on:click="accordionToggle(5, $event)" ref="accordion5"
                ...
                <div class="application-step__content">
                    ...
                    <button type="submit" id="step5-save" class="button button--focused" v-on:click="submitStep(5)"
                            v-bind:disabled="loading">
                    <span v-if="loading">
                        <loading></loading>
                    </span>
                ...
                <!-- START Step 6 -->
                <button class="application-step__heading" v-on:click="accordionToggle(6, $event)" ref="accordion6"
                        v-bind:class="{ '--disabled' : showStep <  6}" data-accordion="6">Step 6: General Details
                </button>
                <div class="application-step__content">
                    <!-- Judgements -->
                    ...
                    <button type="submit" id="step6-save" class="button button--focused" v-on:click="submitStep(6)"
                            v-bind:disabled="loading">
                    <span v-if="loading">
                        <loading></loading>
                    </span>
                ...
                <!-- START Step 7 -->
                <button class="application-step__heading" v-on:click="accordionToggle(7, $event)" ref="accordion7"
                        v-bind:class="{ '--disabled' : showStep <  7}" data-accordion="7">Step 7: Required supporting
                    documents
                </button>
                <div class="application-step__content">
                ...
                <!-- START Step 8 -->
                <button class="application-step__heading" v-on:click="accordionToggle(8, $event)" ref="accordion8"
