    ...
    <ol>
        ...
        <li>
            ...
            <ol>
                ...
                <li>
                    The total deposit amount is Eight Thousand Four Hundred Rand (R8 400.00) and payable to:
                    <table class="--expanded">
                        <tbody>
                        <tr><td width="30%">Bank Account Name</td><td>My Domain Rentals (Pty) Ltd</td></tr>
                        <tr><td width="30%">Bank</td><td>NEDBANK</td></tr>
                        <tr><td width="30%">Branch Code</td><td>123 209</td></tr>
                        <tr><td width="30%">Swift Code</td><td>NEDSZAJJ</td></tr>
                        <tr><td width="30%">Account Number</td><td>1090 345 356</td></tr>
                        <tr><td width="30%">Reference To Use</td><td>Allocated tenant code as per invoice</td></tr>
                        </tbody>
                    </table>
                </li>
        ...
        <li>
            ...
            <ol>
                ...
                <li>
                    The monthly rental amount is Four Thousand Two Hundred Rand (R4 200.00) and payable to:
                    <table class="--expanded">
                        <tbody>
                        <tr><td width="30%">Bank Account Name</td><td>My Domain Rentals (Pty) Ltd</td></tr>
                        <tr><td width="30%">Bank</td><td>NEDBANK</td></tr>
                        ...
                        <tr><td width="30%">Swift Code</td><td>NEDSZAJJ</td></tr>
                        <tr><td width="30%">Account Number</td><td>1090 345 356</td></tr>
                        <tr><td width="30%">Reference To Use</td><td>Use the four digit Tenant account number as detailed on the invoice which you will receive from the Landlord as the reference for your payment. It is very important that the correct reference is used, otherwise the Landlord will not be able to allocate your payment to your account.</td></tr>
                        </tbody>
                    </table>
                </li>
                <li>The Tenant must set up a direct debit order or stop order or make an alternative payment plan to ensure his monthly rental is paid before the first (1st) day of each month.</li>
                <li>The Tenant is not allowed to pay a lower monthly rental amount for any reason.</li>
                <li>
                    If the Tenant pays the monthly rental in cash and if there are bank charges, he must pay for those charges.
                    <br>
        ...
        <li>
            ...
            <ol>
                <li>The Tenant is hereby informed that the Unit it is shown during a viewing at My Domain will not necessarily be the Unit where the Tenant will be placed.</li>
                <li>The Landlord allocates, in its discretion, Units to tenants in accordance with the type of Unit requested by the Tenant. The Tenant therefore does not choose a specific Unit to stay in.</li>
            </ol>
        </li>
        <li>
            <div class="h4">UNIT FURNISHINGS AND THE CONDITION OF THE UNIT</div>
            <p>The Tenant is expected to carefully inspect the Unit and report any damage in writing to My Domain Management within twenty four (24) hours of moving in. My Domain Management will follow up on all reported problems and take corrective action as appropriate.</p>
            <ul>
                ...
                <li>Blind(s) / 1.5m Curtain rail(s) fitted on window(s) <br> (Please note the curtain rail(s) is fitted for a standard 218cm long taped curtain)</li>
            </ul>
            <p>The Tenant accepts responsibility for these items on occupation.</p>
            <p>The Tenant must supply his own linen, i.e. pillows, sheets, blankets or duvets, pillowcases, curtain(s) and towels. Sheets must be used on the beds at all times. Mattresses must NOT be removed from the Units at any time. The Tenant must also supply his own crockery and cookware, which must be</p>
            <p>If the Tenant fails to advise My Domain Management in writing of any problem(s) within twenty (24) hours of moving in, it will be taken that the Unit was in a good and undamaged condition at the Start Date of the Lease Agreement and he/she is satisfied with the Unit. Upon vacating the Unit My Domain Management will do an outgoing inspection together with the Tenant. If the Tenant does not come to the inspection My Domain Management will inspect the Unit without him to see if there are any damages. If there are damages to the Unit part of, or the entire, deposit will be used as detailed in clause 3 above.</p>
        </li>
        <li>
            <div class="h4">THE USE OF THE UNIT</div>
            <p>The Tenant must use the Unit only as a place of residence, and is not permitted to use the Unit or the My Domain premises for the purpose of conducting any business without first obtaining written approval from the Landlord.</p>
        ...
        <li>
            ...
            <ol>
                <li>
                    ...
                    <p>Tenants are not allowed to make any structural changes or additions to the Units or to the My Domain premises.</p>
                </li>
                <li>
                    <div class="h5">SMOKING</div>
                    <p>According to Government legislation smoking of ANY substances or cigarettes is prohibited on the My Domain premises. This policy applies to Units, communal facilities, outside covered areas and within two (2) metres of doorways, entrances and windows. Violation of this policy will, at the discretion of My Domain Management, result in a Two Thousand Rand (R2 000.00) fine.</p>
                    <p>Smoking may set off the fire sensors, requiring the evacuation of the whole building and an expensive call out by the fire brigade. Costs incurred as a result of this will be met by the Tenant responsible.</p>
                    <p>Smokers must use the designated outside smoking areas and dispose of their cigarette butts in the ashtrays provided.</p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <p>Flammable and dangerous items such as fireworks, flammable liquids and gases, home brew kits, bug / pest control bombs, etc. are forbidden on the My Domain premises.</p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <p>Alcohol may not be kept or consumed by Tenants while on the My Domain premises. Violation of this policy will, at the discretion of My Domain Management, result in a One Thousand Rand (R1 000.00) fine.</p>
                    <p>Tenants shall observe socially acceptable practices in all areas of My Domain and must not behave inappropriately or offensively while under the influence of alcohol. Alcohol consumption is not an acceptable excuse for abusive, menacing or obnoxious conduct. My Domain Management does not accept that having a good time needs to involve damage to property, noise, mess, abuse or harassment of others.</p>
                    <p>The brewing of alcoholic beverages on the My Domain premises is prohibited and will result in a Two Thousand Rand (R2 000.00) fine and confiscation of the equipment.</p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <p>Any Tenant tampering with electrical meters, connections and installations shall, at the discretion of My Domain Management, have to pay a One Thousand Rand (R1 000.00) fine.</p>
                </li>
                <li>
        ...
        <li>
            ...
            <p>My Domain cleaning staff prepare individual Units for the arrival of new Tenants. Once occupied, individual Units are not cleaned and this becomes the responsibility of each Tenant. My Domain Management can provide a cleaning service at an additional cost, however assumes no responsibility for risk or loss of personal possessions.</p>
        ...
        <li>
            ...
            <p>Tenants may not fix stickers or other adhesive decorations to walls, ceilings or anywhere in the Unit or the My Domain premises. Most adhesives will remove paint and the use of nails or screws will also cause damage.</p>
            <p>If there is any damage or any holes left that require patching the Tenant will be charged, not only for fixing the holes, but also for painting the entire surface area of the damaged section.</p>
        ...
        <li>
            ...
            <ol>
                ...
                <li>In the case of an emergency i.e. situations that would cause injury to a Tenant or destruction to property (as determined by the My Domain Building Manager and My Domain Management).</li>
        ...
        <li>
            ...
            <p>Each Tenant will be issued with a personally tagged access card for the Lease Period stipulated in the Lease Agreement.</p>
            <p>Access cards are intentionally not labeled with the My Domain street address or Unit number. This is to protect Tenants against theft should the access card be lost or stolen. Please do not identify keys with a name or address. If the access card is faulty please inform My Domain Management and return it to the My Domain Building Manager. It is important that the Tenant does not put any holes in the access card or damage it in any way. Access cards that are lost must be reported to the My Domain Building Manager immediately.</p>
            <p>Tenants will need to provide appropriate identification as well as a signed copy of the first (1st) page of Lease Agreement to be re-issued with a new card. Tenants who lose or damage their access cards will be required to meet the costs of a replacement card.</p>
            <p>Replacement access cards will be charged at R200.00 for each individual access card lost and all access cards must be returned to My Domain Management when vacating the Unit. The charge for non-returned access cards will be taken from the damage deposit.</p>
        </li>
        <li>
        ...
        <li>
            ...
            <p>The communal facilities are attended to by My Domain cleaning staff on a weekly basis; however Tenants share the responsibility for creating a pleasant living environment. The My Domain cleaning staff are not maids and tidy, hygienic, adult attitudes towards household cleanliness are expected.</p>
            <p>Please adhere to the following basic principles:</p>
            <ul>
                <li>Place all rubbish in the appropriate recycling bins provided and dispose of waste appropriately in the designated recycling bins</li>
        ...
        <li>
            ...
            <p>When using cooking equipment in the Units, tenants are required to comply with the signage installed. Failure to comply will likely set off the fire sensors and the Tenant will pay the cost of the fire brigade attending, together with any administration charge imposed by the fire brigade and / or My Domain Management if a false alarm occurs.</p>
            <p>Please adhere to the following basic principles:</p>
            <ul>
                <li>Wipe down kitchen surface after use (ants and other pests can quickly become a problem when food is left out)</li>
            ...
            <p>Failure to maintain proper hygiene standards will incur a Two Hundred Fifty Rand (R250.00) cleaning fee and My Domain cleaning staff will clean the affected area.</p>
        </li>
        <li>
            <div class="h4">LAUNDRY</div>
            <p>There is a laundry located on the first floor of My Domain and this is for Tenant use only.</p>
            <p>Out of respect for other Tenants, please keep the laundry clean and wipe out the machines after use. My Domain has environmentally friendly top-loading washing machines and dryers. The washing machines use less detergent and Tenants should purchase detergents labeled for use in top-loading machines.</p>
            <p>As a matter of courtesy, please empty machines promptly when their operating cycle has ended. If the Tenant is not present in the laundry when his clothes are washing / drying, he must leave a bag or basket on the top of the machine. This is a sign for other Tenants that he wants them to place his fully washed or dried clothes in that container awaiting his return.</p>
            <p>VERY IMPORTANT: Under no circumstances should any Tenant terminate another Tenant&rsquo;s machine cycle early or throw their clothes out of a machine. Penalties for misconduct may apply. No washing or any other items are permitted to be hung outside Unit windows or anywhere in the My Domain communal areas.</p>
        </li>
        <li>
            <div class="h4">VEHICLES AND PARKING</div>
            <p>Motor vehicles, motorcycles and bicycles parked at the My Domain premises at the owner&rsquo;s own risk.</p>
            <p>Tenants with an allocated parking bay must obtain a parking permit from My Domain Management to park in My Domain parking bays. The parking permit is valid for the duration of the Lease Period and should be displayed in the car windscreen. Due to limited parking spaces, only one parking bay per Tenant is allowed.</p>
            <p>My Domain Management will clamp cars parked without permits, those illegally parked in disabled or visitor bays and those parked on red and yellow lines. The clamp release fee of Two Hundred Fifty Rand (R250.00) per day is payable to the My Domain Building Manager. For security reasons, My Domain strongly advises against leaving any items of value visible in your car.</p>
            <p>Motorcycles must be parked in the allocated motorcycle parking spaces. Please use a good locking system to secure all bicycles stored in the racks.</p>
            <p>Owners of vehicles, motorcycles and bicycles which are parked in a way that block access and exit roads will be fined and the vehicle removed.</p>
        </li>
        <li>
            <div class="h4">CONSERVATION OF THE ENVIRONMENT</div>
            <p>My Domain is a community of over 460 Tenants. This means we leave a big footprint on the environment. We ask all Tenants to consider the impact of our significant energy usage and large output of waste products.</p>
            <p>Please adhere to the following basic principles:</p>
            <ul>
                <li>Take time to place cardboard and flattened cardboard packages, paper, juice and milk cartons, glass, plastic bottles and aluminum cans into the appropriate recycling bins.</li>
                <li>Only recyclable items should go in the recycling bins. To do otherwise contaminates the whole recycling program both here and at the waste depot. Do not contaminate the recycling with food or dirty items.</li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    Turn off electrical appliances when not in use (for example, even those little standby lights on the front of the TV use energy!).
                </li>
            </ul>
        </li>
        <li>
