                        ...
                        <tr>
                            <td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center">
                                <div style="cursor:auto;color:#4f4f4f;font-family:Ubuntu;font-size:24px;font-weight:bold;line-height:40px;">
                                    <span style="color: #1b696e">Another application received!</span></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center">
                                <div style="cursor:auto;color:#58585d;font-family:Ubuntu;font-size:15px;line-height:22px;">
                                    An application has been made by <strong>{{$application->first_name}} {{$application->last_name}}</strong> and is waiting for your approval.
                                </div>
                            </td>
                        </tr>
                        </tbody>
